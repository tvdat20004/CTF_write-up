...
class SignatureManager:
    ...
    def gen_sign(self, m: bytes, alea_1, alea_2, i):
        a = int(alea_1)
        b = int(alea_2)
        ...
        assert c == 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
        ...
        assert parity == 1
        randomized_part = bin(self.salt ^ int(randomized_part, 2))[-7:] # 7 pt cuoi 
    ...
    def get_new_signatures(self, alea_1, alea_2):
        if self.credits > 0:
            ...
            for i in range(10):
                ...
                r,s,_ = self.signature_manager.gen_sign(m, alea_1, alea_2, i)
    ...
    while True:
        try:
            ...
            if action == "show_credits":
                ...
                print(dumps(server.get_encrypted_flag()))
